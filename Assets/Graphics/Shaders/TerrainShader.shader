...
#pragma exclude_renderers gles
      ...
      void vert (inout appdata_full v, out Input o)
      {
          ...
          float lHeight = v.vertex.y;
	    	...
	    	else if (lHeight < _MinHeight + _SliceThreeFloorCount + _SliceOneFloorCount + _SliceTwoFloorCount)
	    	{
	    		...
	    		o.sliceIndex = 2;
	    		o.uv_MainTex = TRANSFORM_TEX(v.texcoord,_SliceThreeTexture);
	    	}
	    	else if (lHeight < _MinHeight + _SliceFourFloorCount + _SliceThreeFloorCount + _SliceOneFloorCount + _SliceTwoFloorCount)
	    	{
	    		...
	    		o.sliceIndex = 3;
	    		o.uv_MainTex = TRANSFORM_TEX(v.texcoord,_SliceFourTexture);
	    	}
	    	else //if (lHeight < _MinHeight + _SliceFiveFloorCount)
	    	{
	    		...
	    		o.sliceIndex = 4;
	    		o.uv_MainTex = TRANSFORM_TEX(v.texcoord,_SliceFiveTexture);
	    	}
      ...
      void surf (Input IN, inout SurfaceOutput o)
      {
         ...
         {
         	case 0: 
         	o.Albedo = tex2D (_SliceOneTexture, IN.uv_MainTex).rgb;
         	break;
         	
         	case 1: 
         	o.Albedo = tex2D (_SliceTwoTexture, IN.uv_MainTex).rgb;
         	break;
         	
         	case 2: 
         	o.Albedo = tex2D (_SliceThreeTexture, IN.uv_MainTex).rgb;
         	break;
         	
         	case 3: 
         	o.Albedo = tex2D (_SliceFourTexture, IN.uv_MainTex).rgb;
         	break;
         	
         	case 4: 

         	o.Albedo = tex2D (_SliceFiveTexture, IN.uv_MainTex).rgb;
         	break;
